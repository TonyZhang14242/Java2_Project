...
public class MainController {
    ...
    public List<TopIssueWord> processIssueFreqPrepare(){
        ...
        openIssuesService.getOpenIssues().forEach(openissues -> {names.add(openissues.getTitle());});
        closeIssuesService.getCloseIssues().forEach(closeissues -> {names.add(closeissues.getTitle());});
